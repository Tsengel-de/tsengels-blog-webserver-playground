...
subtitle: Travel and leisure from Niibyul to Dagebyul and Foer Island
feed:
  limit: 10
...
metadata:
  ...
  og:type: article
  og:title: Photo Gallery | Tsengels Blog
  og:description: Photo album
  ...
  twitter:title: Photo Gallery | Tsengels Blog
  twitter:description: Photo album
...
Anyway, I took some time today and moved a couple of photos to the web server to reduce them to a size that can be uploaded to the internet.
> Please enjoy Tsengel's short photo album of the North Sea here 🤗

===

The description and formatting of the album have been corrected as time permits😅🤓
